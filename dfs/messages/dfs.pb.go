...
type JobOrder struct {
	...
	IsReducer    bool     `protobuf:"varint,4,opt,name=is_reducer,json=isReducer,proto3" json:"is_reducer,omitempty"`
	Chunks       []string `protobuf:"bytes,5,rep,name=chunks,proto3" json:"chunks,omitempty"`
	ReducerNodes []string `protobuf:"bytes,6,rep,name=reducer_nodes,json=reducerNodes,proto3" json:"reducer_nodes,omitempty"`
	NumMappers   int64    `protobuf:"varint,7,opt,name=numMappers,proto3" json:"numMappers,omitempty"`
}

func (x *JobOrder) Reset() {
	*x = JobOrder{}
	if protoimpl.UnsafeEnabled {
...
func (x *JobOrder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JobOrder) ProtoMessage() {}

func (x *JobOrder) ProtoReflect() protoreflect.Message {
	mi := &file_proto_dfs_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JobOrder.ProtoReflect.Descriptor instead.
func (*JobOrder) Descriptor() ([]byte, []int) {
	return file_proto_dfs_proto_rawDescGZIP(), []int{13}
}

func (x *JobOrder) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
func (x *JobOrder) GetJobHash() string {
	if x != nil {
		return x.JobHash
	}
	return ""
...
func (x *JobOrder) GetIsReducer() bool {
	if x != nil {
		return x.IsReducer
	}
	return false
...
func (x *JobOrder) GetChunks() []string {
	if x != nil {
		return x.Chunks
	}
	return nil
...
func (x *JobOrder) GetReducerNodes() []string {
	if x != nil {
		return x.ReducerNodes
	}
	return nil
}

func (x *JobOrder) GetNumMappers() int64 {
	if x != nil {
		return x.NumMappers
	}
	return 0
...
func (x *KeyValueNotice) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KeyValueNotice) ProtoMessage() {}

func (x *KeyValueNotice) ProtoReflect() protoreflect.Message {
	mi := &file_proto_dfs_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KeyValueNotice.ProtoReflect.Descriptor instead.
func (*KeyValueNotice) Descriptor() ([]byte, []int) {
	return file_proto_dfs_proto_rawDescGZIP(), []int{21}
}

func (x *KeyValueNotice) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
func (x *KeyValueNotice) GetSize() int64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *KeyValueRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KeyValueRes) ProtoMessage() {}

func (x *KeyValueRes) ProtoReflect() protoreflect.Message {
	mi := &file_proto_dfs_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KeyValueRes.ProtoReflect.Descriptor instead.
func (*KeyValueRes) Descriptor() ([]byte, []int) {
	return file_proto_dfs_proto_rawDescGZIP(), []int{22}
}

func (x *KeyValueRes) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
func (x *KeyValueRes) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *Wrapper) GetJobOrder() *JobOrder {
	if x, ok := x.GetMsg().(*Wrapper_JobOrder); ok {
		return x.JobOrder
	}
	return nil
}
...
func (x *Wrapper) GetJobStatus() *JobStatus {
	if x, ok := x.GetMsg().(*Wrapper_JobStatus); ok {
		return x.JobStatus
	}
	return nil
}

func (x *Wrapper) GetKeyValueNotice() *KeyValueNotice {
	if x, ok := x.GetMsg().(*Wrapper_KeyValueNotice); ok {
		return x.KeyValueNotice
	}
	return nil
}

func (x *Wrapper) GetKeyValueRes() *KeyValueRes {
	if x, ok := x.GetMsg().(*Wrapper_KeyValueRes); ok {
		return x.KeyValueRes
	}
	return nil
}
...
type Wrapper_JobOrder struct {
	JobOrder *JobOrder `protobuf:"bytes,12,opt,name=job_order,json=jobOrder,proto3,oneof"`
}

type Wrapper_JoinReq struct {
	JoinReq *JoinReq `protobuf:"bytes,13,opt,name=join_req,json=joinReq,proto3,oneof"`
}
...
type Wrapper_NStorageRes struct {
	NStorageRes *NStorageRes `protobuf:"bytes,15,opt,name=n_storage_res,json=nStorageRes,proto3,oneof"`
}

type Wrapper_NRetrievalRes struct {
	NRetrievalRes *NRetrievalRes `protobuf:"bytes,16,opt,name=n_retrieval_res,json=nRetrievalRes,proto3,oneof"`
}

type Wrapper_OrderRes struct {
	OrderRes *OrderRes `protobuf:"bytes,17,opt,name=order_res,json=orderRes,proto3,oneof"`
}

type Wrapper_ReplicaReq struct {
	ReplicaReq *ReplicaReq `protobuf:"bytes,18,opt,name=replica_req,json=replicaReq,proto3,oneof"`
}

type Wrapper_JobStatus struct {
	JobStatus *JobStatus `protobuf:"bytes,19,opt,name=job_status,json=jobStatus,proto3,oneof"`
}

type Wrapper_KeyValueNotice struct {
	KeyValueNotice *KeyValueNotice `protobuf:"bytes,20,opt,name=key_value_notice,json=keyValueNotice,proto3,oneof"`
}

type Wrapper_KeyValueRes struct {
	KeyValueRes *KeyValueRes `protobuf:"bytes,21,opt,name=key_value_res,json=keyValueRes,proto3,oneof"`
}

type Wrapper_CStorageReq struct {
	CStorageReq *CStorageReq `protobuf:"bytes,22,opt,name=c_storage_req,json=cStorageReq,proto3,oneof"`
}

type Wrapper_NStorageReq struct {
	NStorageReq *NStorageReq `protobuf:"bytes,23,opt,name=n_storage_req,json=nStorageReq,proto3,oneof"`
}

type Wrapper_CRetrievalReq struct {
	CRetrievalReq *CRetrievalReq `protobuf:"bytes,24,opt,name=c_retrieval_req,json=cRetrievalReq,proto3,oneof"`
}

type Wrapper_NRetrievalReq struct {
	NRetrievalReq *NRetrievalReq `protobuf:"bytes,25,opt,name=n_retrieval_req,json=nRetrievalReq,proto3,oneof"`
}

type Wrapper_ListReq struct {
	ListReq *ListReq `protobuf:"bytes,26,opt,name=list_req,json=listReq,proto3,oneof"`
}

type Wrapper_NodesReq struct {
	NodesReq *NodesReq `protobuf:"bytes,27,opt,name=nodes_req,json=nodesReq,proto3,oneof"`
}

type Wrapper_DeleteReq struct {
	DeleteReq *DeleteReq `protobuf:"bytes,28,opt,name=delete_req,json=deleteReq,proto3,oneof"`
}

type Wrapper_Md5 struct {
	Md5 *Checksum `protobuf:"bytes,29,opt,name=md5,proto3,oneof"`
}

type Wrapper_ChecksumRes struct {
	ChecksumRes *ChecksumRes `protobuf:"bytes,30,opt,name=checksum_res,json=checksumRes,proto3,oneof"`
}
...
func (*Wrapper_JobOrder) isWrapper_Msg() {}
...
func (*Wrapper_JobStatus) isWrapper_Msg() {}

func (*Wrapper_KeyValueNotice) isWrapper_Msg() {}

func (*Wrapper_KeyValueRes) isWrapper_Msg() {}
...
var file_proto_dfs_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x63, 0x68, 0x75, 0x6e, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x4d, 0x0a, 0x09, 0x4a, 0x6f,
	0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x6f, 0x6b, 0x18, 0x01, 0x20,
	...
	0x09, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x40, 0x0a, 0x0e, 0x4b, 0x65, 0x79,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x66,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x37, 0x0a, 0x0b, 0x4b,
	0x65, 0x79, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x65, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x6f, 0x6b,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x02, 0x6f, 0x6b, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x22, 0xc3, 0x01, 0x0a, 0x0b, 0x43, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	...
	,
...
var file_proto_dfs_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_proto_dfs_proto_goTypes = []interface{}{
	...
	(*JobOrder)(nil),       // 13: JobOrder
	(*JoinReq)(nil),        // 14: JoinReq
	(*Heartbeat)(nil),      // 15: Heartbeat
	(*NStorageRes)(nil),    // 16: NStorageRes
	(*NRetrievalRes)(nil),  // 17: NRetrievalRes
	(*OrderRes)(nil),       // 18: OrderRes
	(*ReplicaReq)(nil),     // 19: ReplicaReq
	(*JobStatus)(nil),      // 20: JobStatus
	(*KeyValueNotice)(nil), // 21: KeyValueNotice
	(*KeyValueRes)(nil),    // 22: KeyValueRes
	(*CStorageReq)(nil),    // 23: CStorageReq
	(*NStorageReq)(nil),    // 24: NStorageReq
	(*CRetrievalReq)(nil),  // 25: CRetrievalReq
	(*NRetrievalReq)(nil),  // 26: NRetrievalReq
	(*ListReq)(nil),        // 27: ListReq
	(*NodesReq)(nil),       // 28: NodesReq
	(*DeleteReq)(nil),      // 29: DeleteReq
	(*Checksum)(nil),       // 30: Checksum
	(*ChecksumRes)(nil),    // 31: ChecksumRes
	(*Wrapper)(nil),        // 32: Wrapper
	nil,                    // 33: CStorageRes.ChunkMapEntry
	nil,                    // 34: CStorageRes.ReplicaNodesEntry
	nil,                    // 35: CRetrievalRes.NodeChunksEntry
	nil,                    // 36: NodesRes.NodeReqsEntry
	nil,                    // 37: MapRes.ChunkNodesEntry
	nil,                    // 38: Heartbeat.NewChunksEntry
	nil,                    // 39: CStorageReq.ChunkSizesEntry
}
var file_proto_dfs_proto_depIdxs = []int32{
	33, // 0: CStorageRes.chunk_map:type_name -> CStorageRes.ChunkMapEntry
	34, // 1: CStorageRes.replica_nodes:type_name -> CStorageRes.ReplicaNodesEntry
	35, // 2: CRetrievalRes.node_chunks:type_name -> CRetrievalRes.NodeChunksEntry
	36, // 3: NodesRes.node_reqs:type_name -> NodesRes.NodeReqsEntry
	37, // 4: MapRes.chunk_nodes:type_name -> MapRes.ChunkNodesEntry
	38, // 5: Heartbeat.new_chunks:type_name -> Heartbeat.NewChunksEntry
	39, // 6: CStorageReq.chunk_sizes:type_name -> CStorageReq.ChunkSizesEntry
	...
	13, // 18: Wrapper.job_order:type_name -> JobOrder
	14, // 19: Wrapper.join_req:type_name -> JoinReq
	15, // 20: Wrapper.heartbeat:type_name -> Heartbeat
	16, // 21: Wrapper.n_storage_res:type_name -> NStorageRes
	17, // 22: Wrapper.n_retrieval_res:type_name -> NRetrievalRes
	18, // 23: Wrapper.order_res:type_name -> OrderRes
	19, // 24: Wrapper.replica_req:type_name -> ReplicaReq
	20, // 25: Wrapper.job_status:type_name -> JobStatus
	21, // 26: Wrapper.key_value_notice:type_name -> KeyValueNotice
	22, // 27: Wrapper.key_value_res:type_name -> KeyValueRes
	23, // 28: Wrapper.c_storage_req:type_name -> CStorageReq
	24, // 29: Wrapper.n_storage_req:type_name -> NStorageReq
	25, // 30: Wrapper.c_retrieval_req:type_name -> CRetrievalReq
	26, // 31: Wrapper.n_retrieval_req:type_name -> NRetrievalReq
	27, // 32: Wrapper.list_req:type_name -> ListReq
	28, // 33: Wrapper.nodes_req:type_name -> NodesReq
	29, // 34: Wrapper.delete_req:type_name -> DeleteReq
	30, // 35: Wrapper.md5:type_name -> Checksum
	31, // 36: Wrapper.checksum_res:type_name -> ChecksumRes
	2,  // 37: CStorageRes.ReplicaNodesEntry.value:type_name -> NodeList
	4,  // 38: CRetrievalRes.NodeChunksEntry.value:type_name -> ChunkList
	2,  // 39: MapRes.ChunkNodesEntry.value:type_name -> NodeList
	4,  // 40: Heartbeat.NewChunksEntry.value:type_name -> ChunkList
...
func file_proto_dfs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_dfs_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_dfs_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_dfs_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_dfs_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_dfs_proto_msgTypes[32].OneofWrappers = []interface{}{
		(*Wrapper_JoinRes)(nil),
		...
		(*Wrapper_JobStatus)(nil),
		(*Wrapper_KeyValueNotice)(nil),
		(*Wrapper_KeyValueRes)(nil),
